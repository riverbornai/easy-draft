      ...
      {logs.length === 0 ? (
        ...
        <div className="space-y-2 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
          {logs.map((log, i) => {
            ...
            return (
              <div key={log.id ?? i} className="flex items-start gap-4 py-3 px-4 rounded-xl border border-transparent hover:border-[#E8EDE6] hover:bg-[#F2FFEE]/30 transition-all duration-300 fade-in group">
                {/* Timeline visual */}
