...
export default function PipelineBar({ pipelineStatus = 'idle', currentStep = -1, reviewStatus = null }) {
  ...
  return (
    <div className="bg-[#F2FFEE]/30 border border-[#E8EDE6] rounded-2xl p-4 sm:p-6">
      ...
      <div className="overflow-x-auto lg:overflow-x-visible pb-4 -mb-4 lg:pb-0 lg:mb-0 custom-scrollbar">
        <div className="flex items-start gap-0 pb-8 min-w-[600px] lg:min-w-0">
          {STEPS.map((step, i) => {
